...
if (!function_exists('depot_mikado_styles')) {
    ...
    function depot_mikado_styles() {
        ...
        wp_enqueue_style('depot-mikado-default-style', MIKADO_ROOT . '/style.css');
        wp_enqueue_style('depot-mikado-modules', MIKADO_ASSETS_ROOT . '/css/modules.min.css');
        ...
        if (depot_mikado_is_woocommerce_installed()) {
            if (depot_mikado_load_woo_assets()) {
                ...
                wp_enqueue_style('depot-mikado-woo', MIKADO_ASSETS_ROOT . '/css/woocommerce.min.css');
            }
        }
        ...
        if (depot_mikado_load_woo_assets()) {
            $style_dynamic_deps_array = array('depot-mikado-woo', 'depot-mikado-woo-responsive');
        }

        if (file_exists(MIKADO_ROOT_DIR . '/assets/css/style_dynamic.css') && depot_mikado_is_css_folder_writable() && !is_multisite()) {
            wp_enqueue_style('depot-mikado-style-dynamic', MIKADO_ASSETS_ROOT . '/css/style_dynamic.css', $style_dynamic_deps_array, filemtime(MIKADO_ROOT_DIR . '/assets/css/style_dynamic.css')); //it must be included after woocommerce styles so it can override it
	        ...
	        wp_enqueue_style('depot-mikado-style-dynamic', MIKADO_ASSETS_ROOT.'/css/style_dynamic_ms_id_'. depot_mikado_get_multisite_blog_id() .'.css', $style_dynamic_deps_array, filemtime(MIKADO_ROOT_DIR.'/assets/css/style_dynamic_ms_id_'. depot_mikado_get_multisite_blog_id() .'.css')); //it must be included after woocommerce styles so it can override it
        }

        //is responsive option turned on?
        if (depot_mikado_is_responsive_on()) {
            wp_enqueue_style('depot-mikado-modules-responsive', MIKADO_ASSETS_ROOT . '/css/modules-responsive.min.css');
            ...
            if (depot_mikado_is_woocommerce_installed()) {
                if (depot_mikado_load_woo_assets()) {
                    ...
                    wp_enqueue_style('depot-mikado-woo-responsive', MIKADO_ASSETS_ROOT . '/css/woocommerce-responsive.min.css');
                }
            }
            ...
            if (file_exists(MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css') && depot_mikado_is_css_folder_writable() && !is_multisite()) {
                wp_enqueue_style('depot-mikado-style-dynamic-responsive', MIKADO_ASSETS_ROOT . '/css/style_dynamic_responsive.css', array(), filemtime(MIKADO_ROOT_DIR . '/assets/css/style_dynamic_responsive.css'));
	            ...
	            wp_enqueue_style('depot-mikado-style-dynamic-responsive', MIKADO_ASSETS_ROOT.'/css/style_dynamic_responsive_ms_id_'. depot_mikado_get_multisite_blog_id() .'.css', array(), filemtime(MIKADO_ROOT_DIR.'/assets/css/style_dynamic_responsive_ms_id_'. depot_mikado_get_multisite_blog_id() .'.css'));
            }
        }
...
if (!function_exists('depot_mikado_google_fonts_styles')) {
    ...
    function depot_mikado_google_fonts_styles() {
        ...
        if (count($fonts_array) > 0) {
            ...
            wp_enqueue_style('depot-mikado-google-fonts', esc_url_raw($depot_fonts), array(), '1.0.0');
...
if (!function_exists('depot_mikado_scripts')) {
    ...
    function depot_mikado_scripts() {
        ...
        if (!empty($google_maps_api_key)) {
            wp_enqueue_script('depot-mikado-google-map-api', '//maps.googleapis.com/maps/api/js?key=' . $google_maps_api_key, array(), false, true);
        }

        wp_enqueue_script('depot-mikado-modules', MIKADO_ASSETS_ROOT . '/js/modules.min.js', array('jquery'), false, true);
...
if (!function_exists('depot_mikado_page_custom_style')) {
    ...
    function depot_mikado_page_custom_style() {
        ...
        if ($style !== '') {
            wp_add_inline_style('depot-mikado-modules', $style);
        }
    }
...
if (!function_exists('depot_mikado_print_custom_css')) {
    ...
    function depot_mikado_print_custom_css() {
        ...
        if (!empty($custom_css)) {
            wp_add_inline_style('depot-mikado-modules', $custom_css);
        }
    }
...
if (!function_exists('depot_mikado_print_custom_js')) {
    ...
    function depot_mikado_print_custom_js() {
        ...
        if (!empty($custom_js)) {
            wp_add_inline_script('depot-mikado-modules', $custom_js);
        }
    }
...
if (!function_exists('depot_mikado_get_global_variables')) {
    ...
    function depot_mikado_get_global_variables() {
        ...
        wp_localize_script('depot-mikado-modules', 'mkdGlobalVars', array(
...
if (!function_exists('depot_mikado_per_page_js_variables')) {
    ...
    function depot_mikado_per_page_js_variables() {
        ...
        wp_localize_script('depot-mikado-modules', 'mkdPerPageVars', array(
...
if ( ! function_exists( 'depot_mikado_is_plugin_installed' ) ) {
    /**
     ...
     * @return bool
     */
    function depot_mikado_is_plugin_installed( $plugin ) {
        switch ( $plugin ) {
            case 'core':
                return defined( 'MIKADO_CORE_VERSION' );
                break;
...
if ( ! function_exists('depot_mikado_get_module_part') ) {
    function depot_mikado_get_module_part( $module ) {
        return $module;
    }
}

if ( ! function_exists( 'depot_mikado_enqueue_editor_customizer_styles' ) ) {
    /**
     * Enqueue supplemental block editor styles
     */
    function depot_mikado_enqueue_editor_customizer_styles() {
        wp_enqueue_style( 'depot-style-modules-admin-styles', MIKADO_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/mkd-modules-admin.css' );
        wp_enqueue_style( 'depot-style-handle-editor-customizer-styles', MIKADO_FRAMEWORK_ADMIN_ASSETS_ROOT . '/css/editor-customizer-style.css' );
    }

    // add google font
    add_action( 'enqueue_block_editor_assets', 'depot_mikado_google_fonts_styles' );
    // add action
    add_action( 'enqueue_block_editor_assets', 'depot_mikado_enqueue_editor_customizer_styles' );
}