...
if (!class_exists('DepotMikadoSidebar')) {
    ...
    class DepotMikadoSidebar
    {
        ...
        function template_add_widget_field() {
            ...
            echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_attr__('Enter Name of the new Widget Area', 'depot') . "' name='mkd-add-widget' /></span>";
            echo "\n    <input class='button' type='submit' value='" . esc_attr__('Add Widget Area', 'depot') . "' />";
            echo "\n    " . $nonce;
            echo "\n  </form>";
            echo "\n</script>\n";
        }
