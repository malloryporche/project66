...
if( !function_exists('depot_mikado_get_blog_holder_classes') ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function depot_mikado_get_blog_holder_classes($classes) {
	...
	add_filter( 'depot_mikado_blog_holder_classes', 'depot_mikado_get_blog_holder_classes' );
}
